...
const finalCalibrationManifest = [
  ...
  },
  {
    ...
    explanation:
      "🎭 gives the costume, 🏷️ gives the represented identity, 🏟️ gives the team or place, and 📣 gives public-event cheering; no meet-and-greet scene is required.",
  ...
  },
  {
    ...
    explanation:
      "💧 gives the water, ⬇️ gives falling spray, 🧍 gives the person washing, and 🧼 gives whole-body cleaning; the scene is the activity rather than a repair.",
  ...
  },
  {
    ...
    explanation:
      "🤲 gives the hand-held tool, 🍲 gives the bowl and cooked food, ⬇️ gives downward pressing, and 🍽️ gives the soft side dish; the food is flattened in the bowl, not forced through a strainer.",
    details: "Type: Prep tool",
