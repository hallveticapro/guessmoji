...
const finalCalibrationManifest = [
  ...
  },
  {
    ...
    explanation:
      "⚪ and ⚫ suggest the spotted coat; 🧊 gives the ice haul-out; 📣 represents the bark-like call; and 🫧 shows the underwater dives of this buoyant marine mammal.",
  ...
  },
  {
    ...
    explanation:
      "🍞 gives the bread; 🧩 represents its nooks; ↔️ shows the split; and 🔘 supplies the round form.",
    details: "Type: Bread",
    funFact:
  ...
  },
  {
    ...
    explanation:
      "📜 represents flaky laminated layers; ✨ gives the glaze; 🍓 supplies a fruit filling; and 👐 shows the hand-held baked good.",
  ...
  },
  {
    ...
    explanation:
      "🟤 gives the browned baked rounds; ✂️ shows them split open; 🫗 represents the poured gravy; and 🌶️ supplies the peppered savory seasoning.",
