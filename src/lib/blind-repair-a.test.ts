...
const secondPassARewrites: readonly ExpectedCard[] = [
  ...
  },
  {
    ...
    explanation: "🏜️ places the scavenger on Jakku; 🪵 gives the carried staff; ⚔️ signals the Jedi and lightsaber path; 👩 identifies the human heroine; and 🧭 evokes navigating the wasteland.",
  },
  {
  ...
  },
  {
    ...
    explanation: "🍞 gives the bread base; 🫧 evokes the airy nooks; 🔪 shows the split; 🔥 marks toasting; and 🟤 shows the browned, coarse surface.",
  },
  {
    id: "breakfast-quiche",
    categoryId: "breakfast",
  ...
  },
  {
    ...
    explanation: "🧈 evokes the rich dough; 🔁 shows repeated folds that create flaky layers; 🍯 marks the glaze; 🍓 supplies an optional fruit filling; and 👐 shows the hand-held pastry.",
  },
  {
    ...
    explanation: "🟤 marks the browned biscuit; ✂️ shows it split open; 🫗 shows gravy poured over it; 🌶️ evokes the peppered savory seasoning; and 🥣 shows the serving bowl.",
  },
];
