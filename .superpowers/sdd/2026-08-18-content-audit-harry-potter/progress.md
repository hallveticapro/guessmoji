...
Task 7: fix round 5/5 open after 775a7d9 — corrected Zion's NPS wording to a fixed metal chain and simplified the player-visible Literal Phrases description to child-friendly boundary text; focused/full validation remains green, fresh final two-card plus metadata blind review pending.
